...
class YoBlockchainFollower(YoBaseService):
    ...
    def __init__(self, yo_app, config=None, db=None):
        ...
        try:
            steemd_url = config.config_data['blockchain_follower']['steemd_url']
        except:
            steemd_url = 'https://api.steemit.com'

        self.steemd_rpc = steem.Steem(nodes=[steemd_url])
    ...
    async def store_notification(self, **data):
        ...
        sender_response = await self.yo_app.invoke_private_api(
                ...
                api_method='trigger_notification',
